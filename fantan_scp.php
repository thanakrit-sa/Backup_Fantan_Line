...
function checkSymbol_Bet($text)
{
    ...
    if (strpos($text, "/") == true) {
        ...
        } else if (strlen($bet_textSlash) != 1) {
            $text = "การเดิมพันแบบปกติสามารถกรอกหมายเลขได้เพียง 1 ตำแหน่งเท่านั้น";
        } else if (strlen($bet_textSlash) != 3) {
            $text = "การเดิมพันแบบปกติสามารถกรอกหมายเลขได้เพียง 3 ตำแหน่งเท่านั้น";
        } else {
